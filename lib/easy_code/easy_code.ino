...
void test(){
	Serial.print("velkost F_VALUE ma byt 4: ");Serial.println(sizeof(F_VALUE));
	Serial.print("velkost B_VALUE ma byt 2: ");Serial.println(sizeof(B_VALUE));
	Serial.print("velkost TELEGRAM ma byt 26: ");Serial.println(sizeof(TELEGRAM));
  ...
  Serial.print("odkodovany telegram: ");Serial.println((char*)&msg_orig);
	...
	Serial.print("odkodovany telegram: ");Serial.println((char*)&msg_copy);
	...
	for(int i=0; i<sizeof(TELEGRAM); i++){
		if( orig[i] == copy[i] ){
			Serial.print("   zhoda  : ");Serial.println(i);
		}else{
			Serial.print("!! nezhoda: ");Serial.print(orig[i]);Serial.print(" : ");Serial.print(copy[i]);Serial.print(" : ");Serial.println(i);
		}
	}
  Serial.print("   msg_orig je validny  : ");Serial.println(isValidTelegram(&msg_orig));
  Serial.print("   msg_copy je validny  : ");Serial.println(isValidTelegram(&msg_copy));
